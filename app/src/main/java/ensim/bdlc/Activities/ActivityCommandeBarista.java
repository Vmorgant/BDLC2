...
public class ActivityCommandeBarista extends AppCompatActivity {
    ...
    private Button button_scanner, button_valider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GET INTERFACE
        setContentView(R.layout.activity_commande_barista);
        ...
        toolbar_layout.setTitle("Créer une commande");
        ...
        protected Void doInBackground(Void... params) {
            if (Methodes.internet_diponible(activity)) {
                ...
                if (tableUser.user_exist(num_etu)) {
                    user_exist = true;
                    client = tableUser.get_user(num_etu);
                } else {
                    user_exist = false;
                }
            }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (Methodes.internet_diponible(activity)) {
                if (user_exist) {
                    ...
                    builder.setMessage("Vous allez passer une commande pour "+client.getUsername()+"\nVoulez vous continuer ?")
